...
\jscomment{Challenges + future work}
    \begin{itemize}
        \item An issue currently in consideration came up when I was writing the tic-tac-toe example game.
        \item It is possible for a student game to enter into an infinite loop, and there isn't a good way to handle this at the moment.
        \item One potential solution is to put the game on a thread that times out.
        \item I'm currently looking into a Clojure system called futures to do this.
    \end{itemize}
}
