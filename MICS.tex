...
%\jscomment{Challenges + future work}
    ...
    \begin{itemize}
        \item Near the beginning of this year, I completed the checking functions, with the understanding that they would be used in an introductory class in the future.
