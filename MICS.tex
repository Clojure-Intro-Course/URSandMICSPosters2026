...
%\emcomment{(even? "two"), (even? 2 3)}
    ...
    \texttt{user=>(even? 2)} \\
    \texttt{true} \\
\jscomment{This is probably much too wordy for what you were suggesting, and it definitely doesn't fit on the left column without also moving something else over or cutting a lot from the other sections. What should we do about column organization?}
