...
\emcomment{Students write pure functions, they don't directly manipulate the atoms - need to explain this, perhaps in a separate bullet point}
...
Notice how with the check-range and check-precision functions, I've recreated the format of the internal function call, to show students what is really happening. \\
    ...
    \emcomment{Need to explain, briefly, what students provide and what's stored in the atom; explain that any plain-text game can be implemented this way}
...
\emcomment{Mention what you achieved}
    \begin{itemize}
        \item An issue currently in consideration came up when I was writing the tic-tac-toe example game. \emcomment{Not relevant}
