...
%	\item \emcomment{Includes reasons to teach FP to beginners}
	...
	\item It emphasizes breaking problems into smaller, manageable, easy-to-combine pieces. \emcomment{need to say something about functions being first-class citizens}
...
%that encourages these principles and is a great tool for introducing students to functional programming.
    \item It has a simple prefix notation syntax for fucntion calls and special forms that's consistent across the language: \texttt{(+ 2 3), (filter odd? [1 2 3])}.
...
\emcomment{Add the example right here, combine with the Example building block}
