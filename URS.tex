...
\jscomment{This definitely needs some fixes; I don't expect anyone to know what a Lisp is, or the JVM.}
	...
	\item Clojure is a simple functional programming language.
	% \item Lisp languages have a rich history of being introduced early in programming education [2].
    \item Functional languages are immutable, meaning that when a variable is created, it cannot be changed. % this phrasing feels strange but I'm not sure what else to call them
	...
	\item This approach encourages solving problems with small building blocks called functions.
	...
	\item Many functions in Clojure are \textit{higher-order functions,} which are functions that take other functions as arguments.
...
Notice how with the check-equal and check-range functions, I've recreated the format of the internal function call, to show students what is really happening. \\
